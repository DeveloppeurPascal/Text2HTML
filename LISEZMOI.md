...
>
> La maintenance de ce projet est déplacée vers Codeberg sur https://codeberg.org/PatrickPremartin/Text2HTML
>
...
> [!NOTE]
> Pour ouvrir ou intervenir sur un ticket de ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/Text2HTML/issues
> Pour faire un PULL REQUEST sur ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/Text2HTML/pulls
> Pour toute autre information ou me contacter vous pouvez aussi consulter le site Internet du projet sur https://text2html.olfsoftware.fr ou son devlog sur https://text2html.olfsoftware.fr/dev-corner.html
...
Génère des balises P, BR, UL et LI en fonction du texte source.

* Une ligne vide ferme les balises ouvertes.
...
Consultez [le site de Text to HTML](https://text2html.olfsoftware.fr) pour télécharger sa version compilée, en savoir plus sur son fonctionnement, accéder à des vidéos et articles, connaître les différentes versions disponibles et leurs fonctionnalités, contacter le support utilisateurs...
...
Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://github.com/DeveloppeurPascal/Text2HTML).
...
L'export de la documentation est fait en HTML par [DocInsight](https://devjetsoftware.com/products/documentation-insight/) ou [PasDoc](https://pasdoc.github.io) vers le dossier /docs du dépôt. Vous y avez aussi [accès en ligne](https://developpeurpascal.github.io/Text2HTML) grâce à l'hébergement offert par GitHub Pages.

D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://text2html.olfsoftware.fr) ou [le devlog du projet](https://developpeur-pascal.fr/text2html.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/Text2HTML/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si cette licence ne convient pas à vos besoins (notamment pour un projet commercial) je propose aussi [des licences classiques pour les développeurs et les entreprises](https://text2html.olfsoftware.fr).
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/Text2HTML) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/Text2HTML/issues).
