...
>
> Maintenance of this project has been moved to Codeberg at https://codeberg.org/PatrickPremartin/Text2HTML
>
...
> [!NOTE]
> To open or work on a ticket for this project, go to https://codeberg.org/PatrickPremartin/Text2HTML/issues
> To make a PULL REQUEST on this project, go to https://codeberg.org/PatrickPremartin/Text2HTML/pulls
> For any other information or to contact me, you can also visit the project website at https://text2html.olfsoftware.fr or its devlog at https://text2html.olfsoftware.fr/dev-corner.html.
...
Visit [the Text to HTML website](https://text2html.olfsoftware.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Text2HTML) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://text2html.olfsoftware.fr) or [the project devlog](https://developpeur-pascal.fr/text2html.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Text2HTML/issues) so that I can test and try to correct or provide a workaround.
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://text2html.olfsoftware.fr).
